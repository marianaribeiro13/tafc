...
struct Parameters{
    ...
    int Nmuons_accepted = 3; // Number of muons to propagate (they have to cross both detectors)
    const int N_threads = 1; // Number of threads to use in propagation
    ...
    int n_SIPM = 1; //Number of SIPMS per scintillator (not being used now)
