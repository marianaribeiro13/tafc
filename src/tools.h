...
public:
  ...
  static vector<double> Get_Refracted_Dir(vector<double>& i, vector<double>& n, double thetai); //Get refracted direction vector, from incident and normal directions
