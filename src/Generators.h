...
public:
  ...
  double Generate_Photon_Energy(TSpline3*); //Generates poton energy according to an interpolation, use tools::Interpolate_Photon_Spectrum to get the distribution
  int Generate_Photon_Number(double); //Generates and integer according to a Poisson distribution arround the input
